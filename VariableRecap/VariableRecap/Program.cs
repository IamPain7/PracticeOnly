...
namespace VariableRecap
{
    class Program
    {
        static void Main(string[] args)
        {
           ...
           Step 3: Analyze any errors you might incur, if any, and research how to fix it.
           This is a prime opportunity to exemplify self-learning.
